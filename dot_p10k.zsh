# Generated by Powerlevel10k configuration wizard on 2025-01-14 at 17:38 CET.
...
# sharp heads, blurred tails, 1 line, sparse, fluent, transient_prompt,
...
() {
  ...
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=052
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=86
